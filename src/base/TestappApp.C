...
extern "C" void
TestappApp__registerObjects(Factory & factory)
{
  TestappApp::registerObjects(factory);
}
void
...
extern "C" void
TestappApp__associateSyntax(Syntax & syntax, ActionFactory & action_factory)
{
  TestappApp::associateSyntax(syntax, action_factory);
}
void
